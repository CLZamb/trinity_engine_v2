...
#include <functional>
#include <set>
#include "../../search/headers/ZobristKey.h"
#include "../../logic/headers/player.h"
#include "../../logic/headers/bitboard.h"
#include "search/builtin_engine/search/headers/transposition_table.h"
